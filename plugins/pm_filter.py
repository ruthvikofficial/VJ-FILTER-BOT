      ...
      #      return
        ...
        if PREMIUM_AND_REFERAL_MODE == True:
            buttons = [[
                ...
                InlineKeyboardButton('Free Offers', url=f'http://t.me/VOLT_DEALS2'),
            ...
            buttons = [[
                ...
                InlineKeyboardButton('Free Offers', url=f'https://t.me/VOLT_DEALS2'),
                InlineKeyboardButton('ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ', url=GRP_LNK)
            ],[
                InlineKeyboardButton('ʜᴇʟᴘ', callback_data='help'),
                InlineKeyboardButton('ᴀʙᴏᴜᴛ', callback_data='about')
        ...
        buttons = [[
            ...
            InlineKeyboardButton('Sᴏᴜʀᴄᴇ Cᴏᴅᴇ', url="https://telegram.me/VOLT_DEV")
        ],[
        ...
        btn = [[
            InlineKeyboardButton("⟸ Bᴀᴄᴋ", callback_data="help"),
            InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="telegram.me/VOLT_DEV")
        ]]
        await client.edit_message_media(
            query.message.chat.id, 
            query.message.id, 
