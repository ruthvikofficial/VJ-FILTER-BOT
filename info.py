...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002001403928')).split()]  # For Multiple Id Use One Space Between Each.
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://telegra.ph/file/3a0799a9ff706e820f62d.jpg') # payment code picture url.
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://volt-movies-bot.koyeb.app/")
